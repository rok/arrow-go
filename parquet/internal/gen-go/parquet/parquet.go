...
type SchemaElement struct {
	...
	VectorLength *int32 `thrift:"vector_length,12" db:"vector_length" json:"vector_length,omitempty"`
}
...
func (p *SchemaElement) ReadField12(ctx context.Context, iprot thrift.TProtocol) error {
	if v, err := iprot.ReadI32(ctx); err != nil {
...
func (p *SchemaElement) writeField12(ctx context.Context, oprot thrift.TProtocol) (err error) {
	if p.IsSetVectorLength() {
		if err := oprot.WriteFieldBegin(ctx, "vector_length", thrift.I32, 12); err != nil {
			return thrift.PrependError(fmt.Sprintf("%T write field begin error 12:vector_length: ", p), err)
		}
		if err := oprot.WriteI32(ctx, int32(*p.VectorLength)); err != nil {
			return thrift.PrependError(fmt.Sprintf("%T.vector_length (12) field write error: ", p), err)
		}
		if err := oprot.WriteFieldEnd(ctx); err != nil {
			return thrift.PrependError(fmt.Sprintf("%T write field end error 12:vector_length: ", p), err)
		}
	}
	return err
}
