...
func TestVectorAdditionalElementTypesRoundTrip(t *testing.T) {
	...
	cases := []struct {
		...
		// WriteBatchSize (1024), exercising the FLBA whole-vector page batching.
		{
			...
			listSize:  3, numRows: 1500, wrProps: flbaPageProps, fill: fillFixedSizeBinaryVector,
		},
		{
			name:      "fixed_size_binary-len768",
			elemField: arrow.Field{Name: "element", Type: &arrow.FixedSizeBinaryType{ByteWidth: 8}, Nullable: false},
			listSize:  768, numRows: 1500, wrProps: flbaPageProps, fill: fillFixedSizeBinaryVector,
		},
		{
			name:      "float16-len3",
			elemField: arrow.Field{Name: "element", Type: &arrow.Float16Type{}, Nullable: false},
			listSize:  3, numRows: 1500, wrProps: flbaPageProps, fill: fillFloat16Vector,
		},
		{
			name:      "float16-len100",
			elemField: arrow.Field{Name: "element", Type: &arrow.Float16Type{}, Nullable: false},
			listSize:  100, numRows: 1500, wrProps: flbaPageProps, fill: fillFloat16Vector,
		},
	}
